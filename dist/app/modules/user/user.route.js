...
router.post('/create-faculty', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(faculty_validation_1.createFacultyValidationSchema), user_controller_1.UserController.createFaculty);
...
router.get('/me', (0, auth_1.default)('student', 'faculty', 'admin'), user_controller_1.UserController.getMe);
